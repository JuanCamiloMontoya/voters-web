...
export const generalThunks = () => {
  ...
  >(
    ...
    async (_, { rejectWithValue }) => {
      try {
        const { data } = await apiInstence.get<GetDivisionsResponse[]>(
          '/general/divisions'
        )
        return data
      } catch (error: any) {
  ...
  >(
    ...
    async (_, { rejectWithValue }) => {
      try {
        const { data } = await apiInstence.get<GetHobbiesResponse[]>(
          `/general/hobbies`
        )
        return data
      } catch (error: any) {
  ...
  >(
    ...
    async (_, { rejectWithValue }) => {
      try {
        const { data } = await apiInstence.get<GetOccupationsResponse[]>(
          `/general/occupations`
        )
        return data
      } catch (error: any) {
