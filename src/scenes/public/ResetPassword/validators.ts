...
export const useResetPasswordValidator = () => {
  ...
  const resetPasswordValidator: yup.SchemaOf<ResetPasswordData> = yup.object({
    password: yup.string()
      ...
      .matches(/[a-z]{1,}/, 'La contraseña debe tener mínimo una letra minúscula!')
      .matches(/[A-Z]{1,}/, 'La contraseña debe tener mínimo una letra mayúscula!')
      .matches(/[0-9]{1,}/, 'La contraseña debe tener mínimo un número!')
      .matches(/[!@#$%\-+&_*]{1,}/, 'La contraseña debe tener mínimo caracter especial! Ej: !@#$%-+&_*'),
